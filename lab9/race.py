...
backround= pygame.image.load('lab8/car/AnimatedStreet.png')
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image=pygame.image.load('lab8/car/Enemy.png')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image=pygame.image.load('lab8/car/Player.png')
        self.rect=self.image.get_rect()
...
class coin10(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image=pygame.transform.scale(pygame.image.load('lab8/car/images.jpeg'),(15,15))
...
class coin20(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image=pygame.transform.scale(pygame.image.load('lab8/car/images.jpeg'),(25,25))
        self.image.set_colorkey(white)
        self.rect=self.image.get_rect()
        self.rect.center=(random.randint(40,w-40),0)
...
class coin30(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image=pygame.transform.scale(pygame.image.load('lab8/car/images.jpeg'),(35,35))
        self.image.set_colorkey(white)
        self.rect=self.image.get_rect()
        self.rect.center=(random.randint(40, w-40), 0)
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, eat1):
        ...
        coin1+=1 
        coinnum+=1
        pygame.mixer.Sound('lab8/car/coinsound.mp3').play()
