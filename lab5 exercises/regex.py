...
Оператор фискальных дан_ных: АО"Казахтелеком"Для проверки чека зайдите на сайт:consumer.oofd.kz
ФИСКАЛЬНЫЙ ЧЕК
ФП
ИНК ОФД: 311559
Код ККМ КГД (РНМ): 620300145316
ЗНМ: SWK00034961
WEBKASSA.KZ ad_fdbdsJugyJKJHIOUGHnvcJHsfas adsbd """



import re
#1
#d=re.findall(r"ab*", text)
#print(d)

#2
#d=re.search("ab{2}|ab{3}", text)
#print(d)

#3
#p=re.findall('[a-z]*_[a-z]*', text)
#print(p)

#4
#p=re.findall('[А-Я][а-я]+', text)
#print(p)
#5
#p=re.findall('a.*b', text)
#print(p)
